...
\begin{entrylist}
  ...
  \entry
    ...
    {civicBOT is a tool for monitoring the performance of political parties created by Hub Cívico. It is a Telegram  bot that receives information in text or image format for further analysis.}
  \entry
    {2015}
    {amigaBOT}
