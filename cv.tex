...
\begin{entrylist}
  \entry
    ...
    {\emph{Hub Cívico is a non-profit initiative aiming to facilitate the use of technology in processes of open government. Working with civil society, organizations and institutions, its goal is to accomplish a more effective process of transparency, participation/collaboration and accountability and also to reach a larger number of citizens.}}
  \entry
    {Mar15 Jul15}
    {Intern - Mobile Software Engineer}
    {OKODE, Valencia (Spain)\\
    \href{http://okode.com}{http://okode.com}}
    {\emph{Okode is a technology company specialized in innovative global solutions such as web and mobile applications, business process analysis and deployment of mission critical services in Cloud for international customers in different sectors such as insurance, banking, marketing, communications and logistics.\\}
  ...
  \entry
    ...
    {\emph{Working on ehCOS Suite eHealth project, a set of world-class products that encapsulates hospitals, care centers and all its requirements such as: Electronic Health Record, Enterprise Master Person Index, Patient Management, Patient Safety and Risk Management.}\\
    Skills: Team work, Software Lifecycle, Testing, Java EE, PostgreSQL, Oracle DB, Pentaho.}
  \entry
    {Jul13 Jul14}
...
\begin{entrylist}
  \entry
    ...
    {civicBOT is a tool for monitoring the performance of political parties. It is a Telegram  bot that receives information in text or image format and let's citizens classify this information. After that, all the information is analyzed.}
  \entry
    {2015}
    {amigaBOT}
    {\href{https://github.com/algope/amigaBOT}{https://github.com/algope/amigaBOT}}
    {amigaBOT integrates Google Maps, as well as notifications via email, SMS, push and alerts for the authorities in order to allow victims of domestic violence report a risk by simply sending a message to our BOT based in Telegram.}
    \entry
    {2016}
    {openCityCouncils}
    {\href{https://opencitycouncils.org}{https://opencitycouncils.org}}
    {openCityCouncils is a set of simple, technology-neutral, machine-readable descriptions of council documents that makes the structural and semantic components of digital council documents accessible, supporting the creation of high-value parliamentary and legislative information services that greatly improve efficiency and accountability of the City Councils.}
\end{entrylist}
